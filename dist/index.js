...
const ViewModelContext = React__default.createContext({ vm: rootViewModel });
const ViewControllerContext = React__default.createContext(rootViewController);
...
class ViewController extends React__default.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const innerVC = ({ vm }) => 
            React__default.createElement(ViewControllerContext.Consumer, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 114}}
                ,  parent => {
                    ...
                    return (
                        React__default.createElement(ViewControllerContext.Provider, { value: vc, __self: this, __source: {fileName: _jsxFileName, lineNumber: 138}}
                            ,  children 
                        )
                    );
                }
        ...
        return $viewModel
            ...
            : React__default.createElement(ViewModelContext.Consumer, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 147}}
                ,  innerVC 
              );
    }
}
...
class ViewModelState extends React__default.Component {
    ...
    render() {
        ...
        const innerViewModel = (
            React__default.createElement(ViewModelContext.Provider, { value: { vm }, __self: this, __source: {fileName: _jsxFileName$1, lineNumber: 127}}
                ,  children 
            )
        );
        ...
        return !controller
            ? innerViewModel
            : React__default.createElement(ViewController, { ...controller, $viewModel: vm, ownerId: vm.id, __self: this, __source: {fileName: _jsxFileName$1, lineNumber: 136}}
                    ,  innerViewModel 
              );
    }
}
...
const ViewModel = props => (
    React__default.createElement(ViewModelContext.Consumer, {__self: null, __source: {fileName: _jsxFileName$1, lineNumber: 148}}
        ,  ({ vm: parent }) => {
            ...
            return (
                React__default.createElement(ViewModelState, { vm: vm,
...
const Bind = ({ props, controller, children }) => {
    ...
    return (
        React__default.createElement(ViewModelContext.Consumer, {__self: null, __source: {fileName: _jsxFileName$2, lineNumber: 12}}
            ,  ({ vm }) => !controller
                ? children(mapProps(vm, bindings))
                : React__default.createElement(ViewControllerContext.Consumer, {__self: null, __source: {fileName: _jsxFileName$2, lineNumber: 15}}
...
const withBindings = boundProps => Component => {
    ...
    const ComponentWithBindings = componentProps => (
        React__default.createElement(ViewModelContext.Consumer, {__self: null, __source: {fileName: _jsxFileName$3, lineNumber: 13}}
            ,  ({ vm }) => React__default.createElement(Component, { ...componentProps, ...mapProps(vm, bindings), __self: null, __source: {fileName: _jsxFileName$3, lineNumber: 14}} ) 
        )
    );
...
const useBindings = (..._bindings) => {
    const { vm } = React.useContext(ViewModelContext);
    
    return multiGet(vm, _bindings);
};

const useController = () => {
    const vc = React.useContext(ViewControllerContext);
